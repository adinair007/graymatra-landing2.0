    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div
          ...
          :key="index"
          class="group bg-gray-100/80 dark:bg-gray-800/80 backdrop-blur-sm p-5 rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl hover:bg-saffron/80 hover:text-white transition-all duration-300"
        >
          <img
            :src="service.image"
            :alt="service.alt"
